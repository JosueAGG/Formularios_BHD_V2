...
import com.alldatum.ebx.bhd.form.gdpr.FAnalisis_RiesgoUserService;
...
public class FAnalisis_RiesgoFromFactory implements UserServiceRecordFormFactory {



	@Override
	public UserService<TableViewEntitySelection> newUserServiceForCreate(ForCreate context) {
		  return new FAnalisis_RiesgoUserService<>();
	}
